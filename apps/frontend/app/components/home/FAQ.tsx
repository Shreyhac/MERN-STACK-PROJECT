    ...
    <Container className="py-16 md:py-24">
      ...
      <Accordion type="single" collapsible className="w-full max-w-4xl mx-auto">
        ...
        <AccordionItem value="item-7">
          ...
          <AccordionContent>
            <div className="space-y-3 text-zinc-400">
              <p>Yes! Web to MCP is completely free to use. All users get configurable free captures to experience the full workflow enhancement.</p>
              <p>You can customize your capture limits based on your needs, and the service is designed to work seamlessly with your development process without any payment requirements.</p>
            </div>
          </AccordionContent>
        </AccordionItem>
