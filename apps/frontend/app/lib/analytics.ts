...
export const EVENT_ACTIONS = {
  ...
  // Payment events (removed - no payment integration)
...
// Payment tracking functions (removed - no payment integration)
...
// Payment error tracking (removed - no payment integration)
